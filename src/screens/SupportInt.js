...
class SupportInt extends Component {
render(){
  return (
    <Fragment>
            ...
            <div className="col-md-12">
              ...
              <nav id="breadcrumbs">
                <ul>
                  ...
                  <NavItem to="/">How to</NavItem>
                  <NavItem to="/SupportInt">Support</NavItem>
                </ul>
              </nav>
      ...
      <div className="margin-top-20 col-md-12">
        ...
        <div className="blog-post single-post">
          ...
          <div className="post-content">
            <h3>help students who are suspected to do better or bigger than themselves while they're living as immigrants in this country</h3>
