...
class DonateEdu extends Component {
render(){
  return (
            ...
            <div class="col-md-12">
              ...
              <nav id="breadcrumbs">
                <ul>
                  ...
                  <NavItem to="/DonateEdu">Donate educational Objects</NavItem>
                </ul>
              </nav>
              ...
              <div class="margin-top-20 col-md-12">
                ...
                <div class="blog-post single-post">
                  ...
                  <div class="post-content">
                    <h3>anything you consider as educational might become handy to us</h3>
