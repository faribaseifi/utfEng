...
class HelpActionProjs extends Component {
render(){
  return (
    <Fragment>
            ...
            <div className="col-md-12">
              ...
              <nav id="breadcrumbs">
                <ul>
                  ...
                  <NavItem to="/HelpActionProjs">Help in Action Projects</NavItem>
                </ul>
              </nav>
...
export default HelpActionProjs;
